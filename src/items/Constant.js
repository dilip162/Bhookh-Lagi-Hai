...
//   "https://corsproxy.io/?https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=23.022505&lng=72.5713621&restaurantId=";
// export const menu_url =
//   "https://corsproxy.org/?https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=23.022505&lng=72.5713621&restaurantId=";
export const menu_url =
  "https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=17.3935543&lng=78.6039862&restaurantId=";


  export const FAQdata = [
    {
      "que" : "1. How does Bhookh Lagi Hai? work?",
      "ans" : "Bhookh Lagi Hai? is a user-friendly food ordering platform that connects you with a variety of local restaurants. Simply browse through the menu options, make your selection, place your order, and enjoy delicious meals delivered straight to your doorstep."
    },
    {
      "que" : "2. What types of cuisines are available on Bhookh Lagi Hai?",
      "ans" : "Bhookh Lagi Hai? offers a diverse range of cuisines to cater to every taste bud. From comforting local favorites to exotic global flavors, you'll find a wide variety of options to choose from."
    },
    {
    ...
    {
      "que" : "6. How long does delivery take?",
      "ans" : "Delivery times vary depending on factors such as the restaurant's location, your location, and order volume. Rest assured, we strive to provide accurate estimated delivery times during the checkout process."
    },
    {
      "que" : "7. How do I contact customer support?",
    ...
    {
      "que" : "8. How do I provide feedback about my experience?",
    ...
    {
      "que" : "9. Is Bhookh Lagi Hai? available in my area?",
    ...
    {
      "que" : "10. What happens if there's an issue with my order?",
    ...
    {
      "que" : "11. Can I order from multiple restaurants in the same order?",
    ...
    {
      "que" : "12. Is my personal information secure?",
